  ...
  const accordionData = [
    {
      ...
      description: "Begin your complimentary 7-day trial with a Summarist annual membership. You are under no obligation to continue your subscription, and you will only be billed when the trial period expires. With Premium access, you can learn at your own pace and as frequently as you desire, and you may terminate your subscription prior to the conclusion of the 7-day free trial.",
    },
    {
      title: "Can I switch subscriptions from yearly, or yearly to monthly?",
      description: "While an annual plan is active, it is not feasible to switch to a monthly plan. However, once the current month ends, transitioning from a monthly plan to an annual plan is an option."
    },
    {
      title: "Whats included in the Premium Plan?",
      description: "Premium membership provides you with the ultimate Summarist experience, including unrestricted entry to many best-selling books high-quality audio, the ability to download titles for offline reading, and the option to send your reads to your Kindle"
    },
    {
      title: "Can I cancel my trial or my subscription",
      description: "You will not be charged if you cancel your trial before its conclusion. While you will not have complete access to the entire Summarist library, you can still expand your knowledge with one curated book per day."
    }
  ];
      ...
      <div className="h-screen ">
        ...
        <div className="row flex justify-center">
          <div className="container">
            <div className=" md:mx-28 mb-14 space-y-6 flex-col items-center md:flex-row flex md:justify-between">
            ...
            <div className="flex flex-col text-[#032b41]">
              ...
              <div className="flex flex-col space-y-10 items-center">
                <div 
                onClick={yearlyPlan}
                className={`transition-all duration-300 w-full border-4 ${activeYearly ? "border-[#2BD97C]" :"border-[#bac8ce]"}  p-6 bg-[#f1f6f4] cursor-pointer max-w-[680px] `}>
                  <div className="flex items-start space-x-6">
                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center   border-black`}>
                      <div className={` w-1.5 h-1.5 rounded-full  ${activeYearly ? "bg-black" :"content-none"}`}></div>
                    </div>
                    <div className="flex flex-col items-start space-y-1">
                      ...
                      <span className="text-xs text-[#6B757B]">
                ...
                <div 
                onClick={monthlyPlan}
                className={`transition-all duration-300  w-full border-4 ${activeMonthly ? "border-[#2BD97C]" :"border-[#bac8ce]"} p-6 bg-[#f1f6f4] cursor-pointer max-w-[680px]`}>
                  <div className="flex items-start space-x-6">
                    <div className="w-5 h-5 rounded-full border border-black flex items-center justify-center">
                    <div className={` w-1.5 h-1.5 rounded-full  ${activeMonthly ? "bg-black" :"content-none"}`}></div>
                    </div>
                    <div className="flex flex-col items-start space-y-1">
                      <div className="text-lg space-y-1 font-semibold">
              ...
              <div>
                {
                  accordionData.map((accordion, index) => {
                    <Accordion key={index} title={accordion.title} description={accordion.description}/>
                  })
                }
              </div>
            </div>
            ...
            <div className="py-8 flex justify-center sticky bottom-0 bg-white">
              <div className="flex flex-col items-center space-y-3">
                <div className="w-[300px]">
                  <button className="btn ">Start your 7 day free trial</button>
                </div>
